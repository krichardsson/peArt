...
function start() {
    ...
    for (i = 0; i < 500; i++) {
        ...
        x = (e[0] * 100 + e[1] * 10 + e[2]) * width / 1000;
        y = (p[0] * 100 + p[1] * 10 + p[2]) * height / 1000;
        radius = (e[2] * 100 + p[1] * 10 + e[0]) * maxRadius / 1000;

        r = (e[0] * 100 + p[0] * 10 + e[1]) / 4;
        g = (e[1] * 100 + p[2] * 10 + p[0]) / 4;
        b = (e[2] * 100 + p[1] * 10 + p[2]) / 4;
...
function getE(i) {
    return [rndSingleDigit(), rndSingleDigit(), rndSingleDigit()];
}
